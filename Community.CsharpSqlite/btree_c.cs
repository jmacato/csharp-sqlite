    ...
    */
        ...
        */
        ...
        )
        {
            ...
            {
                if (pPage.hasData != 0)
                    n += (ushort) getVarint32(pCell, iCell + n, ref nPayload);
                else
                    nPayload = 0;
                n += (ushort) getVarint(pCell, iCell + n, ref pInfo.nKey);
                        ...
                        private static void zeroPage(MemPage pPage, int flags)
                        {
                            ...
                            if (pBt.secureDelete)
                                Array.Clear(data, hdr,
                                    pBt.usableSize - hdr); //memset(&data[hdr], 0, pBt->usableSize - hdr);
...
p.sharable = 1;
            ...
            pBt.secureDelete = true;
                                      ...
                                      */
                                            ...
                                            Debug.Assert(
                                                (pBt.pageSize & 7) == 0); /* 8-byte alignment of pageSize */
...
if( p.pNext ) p.pNext.pPrev = p.pPrev;
                                    ...
                                    */
                                    ...
                                    private static int sqlite3BtreeSetSafetyLevel(Btree p, int level,
                                        int fullSync)
                                    {
                                        var pBt = p.pBt;
                                        Debug.Assert(sqlite3_mutex_held(p.db.mutex));
                                ...
                                */
                                    ...
                                    */
                                    private static uint sqlite3BtreeMaxPageCount(Btree p, uint mxPage)
                                    {
                                        uint n;
                                        sqlite3BtreeEnter(p);
...
return BTREE_AUTOVACUUM_NONE;
                                    ...
                                    private static int lockBtree(BtShared pBt)
                                    {
                                        ...
                                        */
                                        ...
                                        if (nPage > 0)
                                        {
                                            ...
                                            */
                                            if (memcmp(page1, 21, "\x0040\x0020\x0020", 3) != 0
                                            ) //   "\100\040\040"
                                    ...
                                    */
                                    private static int newDatabase(BtShared pBt)
                                    {
                                        ...
                                        Debug.Assert(sqlite3_mutex_held(pBt.mutex));
                                        rc = sqlite3PagerPagecount(pBt.pPager, ref nPage);
                                        if (rc != SQLITE_OK || nPage > 0) return rc;
                                        pP1 = pBt.pPage1;
                                                            ...
                                                            if (offset < pCur.info.nLocal)
                                                            {
                                                                ...
                                                                rc = copyPayload(aPayload,
                                                                    (uint) (offset + pCur.info.iCell +
                                                                            pCur.info.nHeader), pBuf,
                                                                    pBufOffset, (uint) a, eOp, pPage.pDbPage);
                                                                offset = 0;
                                                    ...
                                                    */
                                                        ...
                                                        */
                                                        ...
                                                        )
                                                        {
                                                            ...
                                                            Debug.Assert(
                                                                pIdxKey == null == (pCur.pKeyInfo == null));
                                                            ...
                                                            for (;;)
                                                            {
                                                                ...
                                                                ** a moveToChild() or moveToRoot() call would have detected corruption.  */
                                                                ...
                                                                for (;;)
                                                                {
                                                                    int idx = pCur.aiIdx[
                                                                        pCur
                                                                            .iPage]; /* Index of current cell in pPage */
                                                                    int
                                                                ...
                                                                do
                                                                {
                                                                    ...
                                                                    else if (k > 0)
                                                                    {
                                                                        ...
                                                                        if (nearby > 0)
                                                                        {
                                                                            ...
                                                                            int dist;
                                                                            closest = 0;
                                                                            dist = (int) (sqlite3Get4byte(aData,
                                                                                8) - nearby);
                                                                            if (dist < 0) dist = -dist;
                                                                            for (i = 1; i < k; i++)
                                                                            {
                                                                        ...
                                                                        */
                                                                            ...
                                                                            ref int pRC)
                                                                        {
                                                                            ...
                                                                            testcase(pc == get2byte(data,
                                                                                hdr + 5));
                                                                            testcase(pc + sz == pPage.pBt
                                                                                .usableSize);
                                                                            if (pc < get2byte(data, hdr + 5) ||
                                                                                        ...
                                                                                        while (true)
                                                                                        {
                                                                                            ...
                                                                                            if (rc != 0)
                                                                                            {
                                                                                                apOld =
                                                                                                    new MemPage
                                                                                                    [i +
                                                                                                     1]; //memset(apOld, 0, (i+1)*sizeof(MemPage*));
                                                                                                goto
                                                                                                    balance_cleanup;
                                                                                            }
                                                                                    ...
                                                                                    */
                                                                                            ...
                                                                                            dxFreeSchema xFree)
                                                                                    {
                                                                                            ...
                                                                                            nBytes != 0)
                                                                                        {
                                                                                            pBt.pSchema =
                                                                                                new
                                                                                                    Schema(); //sqlite3MallocZero(nBytes);
                                                                                            pBt.xFreeSchema =
                                                                                                xFree;
                                                                                        }
