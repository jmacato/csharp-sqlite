        ...
        */
        ...
        )
        {
            ...
            if (zFunctionName == null ||
                ...
                xFunc == null && xFinal != null && xStep == null ||
                xFunc == null && xFinal == null && xStep != null || nArg < -1 || nArg > SQLITE_MAX_FUNCTION_ARG ||
        ...
        private static int sqlite3_file_control(sqlite3 db, string zDbName, int op, ref int pArg)
        {
            ...
            if (iDb < db.nDb)
            {
                ...
                if (pBtree != null)
                {
                    ...
                    if (fd.pMethods != null) rc = sqlite3OsFileControl(fd, (uint) op, ref pArg);
            ...
            switch (op)
            {
              ...
              TCLsqlite3PendingByte.iValue = sqlite3PendingByte;
                ...
                */
                ...
                {
                    var db = (sqlite3) va_arg(ap, "sqlite3"); //sqlite3 *db = va_arg(ap, sqlite3*);
                    var x = (int) va_arg(ap, "int"); //int x = va_arg(ap,int);
                ...
                */
                ...
                {
                    var zWord = (string) va_arg(ap, "char*");
