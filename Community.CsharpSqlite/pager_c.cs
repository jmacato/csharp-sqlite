    ...
    */
        ...
        */
        private static int readJournalHdr(
            ...
            ref uint pNRec, /* OUT: Value read from the nRec field */
            ref uint pDbSize /* OUT: Value of original database size field */
        )
        {
            int rc; /* Return code */
            var aMagic = new byte[8]; /* A buffer to hold the magic header */
            ...
            */
            ...
            if (pPager.journalOff == 0)
            {
                ...
                ushort iPageSize16; /* Copy of iPageSize in 16-bit variable */
                ...
                */
                if (iPageSize < 512 || iSectorSize < 32
                    ...
                    */
                    iPageSize16 = (ushort) iPageSize;
                    rc = sqlite3PagerSetPagesize(pPager, ref iPageSize16, -1);
                    testcase(rc != SQLITE_OK);
                    Debug.Assert(rc != SQLITE_OK || iPageSize16 == (ushort) iPageSize);
                        ...
                        ** Do this before any decoding. */
                                ...
                                */
                                private static int pager_delmaster(Pager pPager, string zMaster)
                                {
                                    ...
                                    */
                                    pMaster =
                                        new sqlite3_file(); // (sqlite3_file*)sqlite3MallocZero( pVfs.szOsFile * 2 );
                                    pJournal =
                                        new sqlite3_file(); // (sqlite3_file*)( ( (u8*)pMaster ) + pVfs.szOsFile );
                                    if (null == pMaster)
                                    {
                                        rc = SQLITE_NOMEM;
                                    }
                                    ...
                                    if (!pPager.tempFile)
                                        ...
                                        */
                                        private static int pager_playback(Pager pPager, int isHot)
                                        {
                                            ...
                                            int
                                                needPagerReset; /* True to reset page prior to first page rollback */
                                            ...
                                            while (true)
                                            {
                                                ...
                                                */
                                                if (nRec == 0xffffffff)
                                                {
                                                    ...
                                                    nRec = (uint) ((szJ - JOURNAL_HDR_SZ(pPager)) /
                                                ...
                                                */
                                                if (nRec == 0 && 0 == isHot &&
                                                    ...
                                                    pPager.journalOff)
                                                {
                                                    nRec = (uint) ((szJ - pPager.journalOff) /
                                                                   JOURNAL_PG_SZ(pPager));
                                                    isUnsync = 1;
                                                }
                                                ...
                                                */
                                                for (u = 0; u < nRec; u++)
                                                {
                                                    ...
                                                    rc = pager_playback_one_page(pPager, 1, isUnsync,
                                                        ref pPager.journalOff, 0, null);
                                                    if (rc != SQLITE_OK)
                                                    {
                                                        if (rc == SQLITE_DONE)
                                                        {
                                            ...
                                            */
                                            ...
                                            Debug.Assert(
                                                ...
                                                sqlite3OsFileControl(pPager.fd, SQLITE_FCNTL_DB_UNCHANGED,
                                                    ref iDummy) >= SQLITE_OK
                                            );
                                            ...
                                            PagerSavepoint pSavepoint)
                                        {
                                            ...
                                            */
                                            if (pSavepoint != null)
                                            {
                                                ...
                                                while (rc == SQLITE_OK && pPager.journalOff < iHdrOff)
                                                    rc = pager_playback_one_page(pPager, 1, 0,
                                                        ref pPager.journalOff, 1, pDone);
                                            ...
                                            */
                                            while (rc == SQLITE_OK && pPager.journalOff < szJ)
                                            {
                                                ...
                                                uint nJRec = 0; /* Number of Journal Records */
                                                uint dummy = 0;
                                            ...
                                            */
                                            if (pSavepoint != null)
                                            {
                                                    ...
                                                    ii++)
                                                {
                                                    ...
                                                    rc = pager_playback_one_page(pPager, 0, 0, ref offset, 1,
                                                        pDone);
                                                }
                                        ...
                                        */
                                        ...
                                        private static void sqlite3PagerSetSafetyLevel(Pager pPager, int level,
                                            bool bFullFsync)
                                        {
                                            pPager.noSync = level == 1 || pPager.tempFile;
                                            pPager.fullSync = level == 3 && !pPager.tempFile;
                                            pPager.sync_flags =
                                                bFullFsync ? SQLITE_SYNC_FULL : SQLITE_SYNC_NORMAL;
    ...
    static void pagerReportSize( Pager pPager ) { }
                                    ...
                                    */
                                        private static int sqlite3PagerSetPagesize(Pager pPager,
                                            ref ushort pPageSize, int nReserve)
                                        {
                                            ...
                                            if (rc == SQLITE_OK)
                                            {
                                                ...
                                                pPageSize = (ushort) pPager.pageSize;
                                        ...
                                        */
                                        private static uint sqlite3PagerMaxPageCount(Pager pPager, uint mxPage)
                                        {
...
//# define enable_simulated_io_errors()
                                    ...
                                    */
                                        ...
                                        */
                                        private static int sqlite3PagerPagecount(Pager pPager, ref uint pnPage)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                long n = 0; /* File size in bytes returned by OsFileSize() */
                                        ...
                                        */
                                        private static int pager_wait_on_lock(Pager pPager, int locktype)
                                        {
                                            ...
                                            */
                                            ...
                                            Debug.Assert(
                                                pPager.state >= PAGER_SHARED || pPager.dbModified == false);
                                        ...
                                        private static int pager_write_pagelist(PgHdr pList)
                                        {
                                            ...
                                            */
                                            if (!isOpen(pPager.fd))
                                            {
                                                ...
                                                rc = pagerOpentemp(pPager, ref pPager.fd,
                                                    (int) pPager.vfsFlags);
                                            }
...
pList.pageHash = pager_pagehash(pList);
                                        ...
                                        */
                                        private static int subjournalPage(PgHdr pPg)
                                        {
                                            ...
                                            if (isOpen(pPager.sjfd))
                                            {
                                                ...
                                                if (rc == SQLITE_OK)
                                                    rc = sqlite3OsWrite(pPager.sjfd, pData2, pPager.pageSize,
                                                        offset + 4);
                                            }
                                        ...
                                        */
                                        ...
                                        )
                                        {
                                            ...
                                            ushort szPageDflt =
                                                SQLITE_DEFAULT_PAGE_SIZE; /* Default page size */
                                            ...
                                            */
                                            if (!string.IsNullOrEmpty(zFilename))
                                            {
                                                ...
                                                zPathname = new StringBuilder(
                                                    nPathname * 2); // sqlite3Malloc( nPathname * 2 );
                                                if (zPathname == null) return SQLITE_NOMEM;
#if !SQLITE_OMIT_MEMORYDB
                                                if (zFilename == ":memory:"
                                                ) //if( strcmp(zFilename,":memory:")==null )
                                                {
                                                    memDb = 1;
                                                    zPathname.Length = 0;
                                                }
                                                        ...
                                                        if (rc == SQLITE_OK && !readOnly)
                                                        {
                                                            ...
                                                            if (szPageDflt < pPager.sectorSize)
                                                            {
                                                                if (pPager.sectorSize >
                                                                    ...
                                                                    szPageDflt = (ushort) pPager.sectorSize;
                                                            }
#if SQLITE_ENABLE_ATOMIC_WRITE
{
...
szPageDflt = ii;
                                                    ...
                                                    */
                                                    private static int readDbPage(PgHdr pPg)
                                                    {
                                                        var pPager =
                                                            pPg
                                                                .pPager; /* Pager object associated with page pPg */
                                                        var pgno = pPg.pgno; /* Page number to read */
                                                        int rc; /* Return code */
                                                        long iOffset; /* Byte offset of file to read from */
#if SQLITE_OMIT_MEMORYDB
...
//memset(pPg->pData, 0, pPager.pageSize);
                                                        ...
                                                        rc = sqlite3OsRead(pPager.fd, pPg.pData,
                                                            pPager.pageSize, iOffset);
                                                        if (rc == SQLITE_IOERR_SHORT_READ) rc = SQLITE_OK;
                                                        if (pgno == 1)
                                                        {
                                                            if (rc != 0
      ...
      */
                                                                ...
                                                                Buffer.BlockCopy(pPg.pData, 24,
                                                                    pPager.dbFileVers, 0,
                                                                    pPager.dbFileVers.Length);
                                                        }

                                                        if (CODEC1(pPager, pPg.pData, pPg.pgno, SQLITE_DECRYPT))
                                                            rc =
                                                                SQLITE_NOMEM; //CODEC1(pPager, pPg.pData, pPg.pgno, 3, rc = SQLITE_NOMEM);
#if SQLITE_TEST
      int iValue;
      ...
      PAGER_INCR( ref pPager.nRead );
                                                    ...
                                                    */
                                                    private static int sqlite3PagerSharedLock(Pager pPager)
                                                    {
                                                        var rc = SQLITE_OK; /* Return code */
                                                        var isErrorReset =
                                                            false; /* True if recovering from error state */
                                                                ...
                                                                sqlite3PcachePagecount(pPager.pPCache) > 0)
                                                            {
                                                                ...
                                                                */
                                                                ...
                                                                else
                                                                {
                                                                    dbFileVers =
                                                                        new byte[dbFileVers
                                                                            .Length]; //memset(dbFileVers, 0, dbFileVers).Length;
                                                                }
                                                    ...
                                                    */
                                                    ...
                                                    )
                                                    {
                                                        ...
                                                        ** Otherwise, request the page from the PCache layer. */
                                                        ...
                                                        Debug.Assert(
                                                            ppPage.pPager == pPager || ppPage.pPager == null);
                                                    ...
                                                    private static int pager_open_journal(Pager pPager)
                                                    {
                                                        ...
                                                        */
                                                        ...
                                                        pPager.pInJournal =
                                                            sqlite3BitvecCreate(
                                                                pPager
                                                                    .dbSize); // sqlite3MallocZero(pPager.dbSize / 8 + 1);
...
Debug.Assert( 0==MEMDB && !pPager.tempFile );
                                                    ...
                                                    */
                                                            ...
                                                            */
                                                            if (rc == SQLITE_OK && pPager.journalMode !=
                                                        ...
                                                        Debug.Assert(
                                                            !isOpen(pPager.jfd) || pPager.journalOff > 0 ||
                                                            rc != SQLITE_OK);
                                                        if (rc != SQLITE_OK)
                                                        {
...
CHECK_PAGE(pPg);
                                                  ...
                                                  */
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            */
                                                            rc = sqlite3PagerBegin(pPager, false,
                                                                pPager.subjInMemory);
                                                            if (NEVER(rc != SQLITE_OK)) return rc;
                                                            if (!isOpen(pPager.jfd) && pPager.journalMode !=
                                                                PAGER_JOURNALMODE_OFF)
                                                            {
                                                                Debug.Assert(pPager.useJournal != 0);
                                                                rc = pager_open_journal(pPager);
                                                    ...
                                                    */
                                                    private static int sqlite3PagerWrite(DbPage pDbPage)
                                                    {
                                                        ...
                                                        if (nPagePerSector > 1)
                                                        {
                                                            ...
                                                            uint
                                                                nPage; /* Number of pages starting at pg1 to journal */
                                                            int ii; /* Loop counter */
                                                            var needSync =
...
int DIRECT_MODE = isDirectMode;
                                                        ...
                                                        if (!pPager.changeCountDone && pPager.dbSize > 0)
                                                        {
                                                            ...
                                                            uint
                                                                change_counter; /* Initial value of change-counter field */
                                                            ...
                                                            */
                                                            ...
                                                            if (rc == SQLITE_OK)
                                                            {
                                                                ...
                                                                change_counter =
                                                                    sqlite3Get4byte(pPager.dbFileVers);
                                                                change_counter++;
                                                            ...
                                                            */
                                                            ...
                                                            if (rc != SQLITE_OK)
                                                            {
                                                                if (needSyncPgno <= pPager.dbOrigSize)
                                                                {
                                                                    ...
                                                                    var pTemp =
                                                                        new uint[pPager.pTmpSpace.Length];
                                                                    sqlite3BitvecClear(pPager.pInJournal,
                                                                        needSyncPgno,
...
*/
                                                    ...
                                                    ** locking-mode.
                                                    */
                                                    private static bool sqlite3PagerLockingMode(Pager pPager,
                                                        int eMode)
                                                    {
                                                    ...
                                                    */
                                                    private static int sqlite3PagerJournalMode(Pager pPager,
                                                        int eMode)
                                                    {
...
0==MEMDB
                                                    ...
                                                    */
                                                    private static long sqlite3PagerJournalSizeLimit(
                                                        Pager pPager, long iLimit)
                                                    {
                                                    ...
                                                    */
                                                    private static sqlite3_backup sqlite3PagerBackupPtr(
                                                        Pager pPager)
                                                    {
