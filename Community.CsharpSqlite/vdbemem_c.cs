    ...
    public partial class Sqlite3
    {
        ...
        */
        private static int sqlite3VdbeChangeEncoding(Mem pMem, int desiredEnc)
        {
            ...
            {
                if (pMem.z == null && pMem.zBLOB != null)
...
return SQLITE_OK;
  ...
  return r;
        ...
        private static double sqlite3VdbeRealValue(Mem pMem)
        {
            ...
            if ((pMem.flags & (MEM_Str | MEM_Blob)) != 0)
            {
                ...
                if (sqlite3VdbeChangeEncoding(pMem, SQLITE_UTF8) != 0
                    ...
                    return 0;
                if (pMem.zBLOB != null)
                    sqlite3AtoF(Encoding.UTF8.GetString(pMem.zBLOB, 0, pMem.zBLOB.Length), ref val);
        ...
        */
        ...
        {
            if ((pMem.flags & MEM_Frame) != 0) sqlite3VdbeFrameDelete(pMem.u.pFrame);
            ...
            */
            if (xDel == SQLITE_TRANSIENT)
            {
                ...
                if (enc == 0)
                {
                    pMem.z = null;
                    pMem.zBLOB = sqlite3Malloc(n);
                    for (var i = 0; i < n && i < z.Length - offset; i++) pMem.zBLOB[i] = (byte)z[offset + i];
                }
                else
                {
        ...
        */
        private static string sqlite3ValueText(sqlite3_value pVal, int enc)
        {
            ...
            if ((pVal.flags & MEM_Str) != 0)
            {
                ...
                if ((enc & SQLITE_UTF16_ALIGNED) != 0 && 1 == (1 & pVal.z[0])
