            ...
            */
            ...
            if (p.pLimit != null)
            {
                ...
                if (sqlite3ExprIsInteger(p.pLimit, ref n) != 0)
                {
                    ...
                    if (n == 0) sqlite3VdbeAddOp2(v, OP_Goto, 0, iBreak);
                }
                else
                {
...
break;
    ...
    */
        private static byte minMaxQuery(Select p)
        {
            ...
            if (string.Compare(pExpr.u.zToken, "min", StringComparison.InvariantCultureIgnoreCase) == 0
            ) //sqlite3StrICmp(pExpr->u.zToken,"min")==0 )
                return WHERE_ORDERBY_MIN;
            if (string.Compare(pExpr.u.zToken, "max", StringComparison.InvariantCultureIgnoreCase) == 0
            ) //sqlite3StrICmp(pExpr->u.zToken,"max")==0 )
...
if (sqlite3AuthCheck(pParse, SQLITE_SELECT, 0, 0, 0)) return 1;
                                                ...
                                                if (pDest.eDest <= SRT_Discard
                                                ) //IgnorableOrderby(pDest))
                                                {
                                                    Debug.Assert(
                                                        pDest.eDest == SRT_Exists ||
...
** processed */
                                            ...
                                            */
                                            ...
                                            private class Keyword
                                            {
                                                ...
                                                public readonly byte
                                                    nChar; /* Length of the keyword in characters */
                                            ...
                                            */
                                            private static Expr substExpr(
                                                sqlite3
                                                    db, /* Report malloc errors to this connection */
                                            ...
                                            )
                                            {
                                                ...
                                                if (pExpr.op == TK_COLUMN && pExpr.iTable == iTable)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        Debug.Assert(
                                                            pExpr.pLeft == null &&
                                                            pExpr.pRight == null);
                                                        pNew = sqlite3ExprDup(db,
                                                            pEList.a[pExpr.iColumn].pExpr, 0);
                                                        if (pExpr.pColl != null)
                                                ...
                                                {
                                                    pExpr.pLeft = substExpr(db, pExpr.pLeft, iTable,
                                                        pEList);
                                                    pExpr.pRight = substExpr(db, pExpr.pRight, iTable,
                                                        pEList);
                                                    if (ExprHasProperty(pExpr, EP_xIsSelect))
                                                        substSelect(db, pExpr.x.pSelect, iTable,
                                                            pEList);
                                                    else
                                                        substExprList(db, pExpr.x.pList, iTable,
                                                            pEList);
                                                }
                                            ...
                                            )
                                            {
                                                ...
                                                for (i = 0; i < pList.nExpr; i++)
                                                    pList.a[i].pExpr = substExpr(db, pList.a[i].pExpr,
                                                        iTable, pEList);
                                            }
                                            ...
                                            )
                                            {
                                                ...
                                                Debug.Assert(
                                                    pSrc !=
                                                    null); /* Even for (SELECT 1) we have: pSrc!=0 but pSrc->nSrc==0 */
                                                if (ALWAYS(pSrc))
