...
#endif
            public ushort pageSize; /* Total number of bytes on a page */
            public ushort usableSize; /* Number of usable bytes on each page */
...
public u8 isPending;            /* If waiting for read-locks to clear */
        ...
        */
        ...
        public struct CellInfo
        {
            ...
            {
                if (ci.iCell >= ci.pCell.Length || iCell >= pCell.Length) return false;
