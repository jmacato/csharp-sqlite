                ...
                */
                switch (xtype)
                {
                    ...
                    case etRADIX:
                        ...
                        {
                            if (flag_longlong)
                                longvalue = (long) va_arg(ap, "longlong int");
                            else if (flag_long)
                                longvalue = (long) va_arg(ap, "long int");
                            else
                                longvalue = (long) va_arg(ap, "long");
                            prefix = '\0';
                        }
...
for(idx = precision, rounder = 0.4999; idx>0; idx--, rounder *= 0.1);
        ...
        */
        ...
        {
            if (p.zText.ToString() != p.zBase.ToString()) sqlite3DbFree(p.db, ref p.zText);
            p.zText.Length = 0;
        }
        ...
        */
        public static string sqlite3_snprintf(int n, ref StringBuilder zBuf, string zFormat, params object[] ap)
        {
            //va_list ap;
            //StrAccum acc = new StrAccum( SQLITE_PRINT_BUF_SIZE );
        ...
        public static string sqlite3_snprintf(int n, ref string zBuf, string zFormat, params object[] ap)
        {
            string z;
            //va_list ap;
...
*/
    ...
    */
        private static void sqlite3DebugPrintf(string zFormat, params object[] ap)
        {
            //va_list ap;
            //StrAccum acc = new StrAccum();
            var zBuf = new StringBuilder(SQLITE_PRINT_BUF_SIZE);
