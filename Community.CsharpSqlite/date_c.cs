        ...
        */
        private static int parseYyyyMmDd(string zDate, DateTime p)
        {
            ...
            if (getDigits(zDate.Substring(zIndex), 4, 0, 9999, '-', ref Y, 2, 1, 12, '-', ref M, 2, 1, 31, '\0',
                ref D) != 3) return 1;
            zIndex += 10; // zDate += 10;
            while (zIndex < zDate.Length && (sqlite3Isspace(zDate[zIndex]) || 'T' == zDate[zIndex])) zIndex++;
