        ...
        private static void sqlite3ExprAssignVarNumber(Parse pParse, Expr pExpr)
        {
            ...
            else if (z[0] == '?')
            {
                ...
                ** use it as the variable number */
                var i = atoi(z.Substring(1)); //atoi((char*)&z[1]);
                pExpr.iColumn = (short) i;
                testcase(i == 0);
                testcase(i == 1);
            ...
            else
            {
                ...
                */
                ...
                if (i >= pParse.nVarExpr)
                {
                    ...
                    {
                        var oldLength = pParse.nVarExprAlloc;
                        pParse.nVarExprAlloc += pParse.nVarExprAlloc + 10;

                        var newXper = new Expr[pParse.nVarExprAlloc];
                        for (var iter = 0; iter < newXper.Length && iter < oldLength; iter++)
        ...
        */
        private static int dupedExprStructSize(Expr p, int flags)
        {
            ...
            else
            {
                ...
                if (p.pLeft != null || p.pRight != null || p.pColl != null || p.x.pList != null ||
                    p.x.pSelect != null)
        ...
        */
        private static void sqlite3ExprIfTrue(Parse pParse, Expr pExpr, int dest, int jumpIfNull)
        {
            ...
            switch (op)
            {
                ...
                {
                    var destIfFalse = sqlite3VdbeMakeLabel(v);
                    var destIfNull = jumpIfNull != 0 ? dest : destIfFalse;
                    sqlite3ExprCodeIN(pParse, pExpr, destIfFalse, destIfNull);
