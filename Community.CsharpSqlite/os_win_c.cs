...
return SQLITE_OK;
        ...
        */
        private static int sqlite3_fileSize(sqlite3_file id, ref long pSize)
        {
            //DWORD upperBits;
            //DWORD lowerBits;
            //  sqlite3_file pFile = (sqlite3_file)id;
      ...
      */
      ...
      zBuf = "Unknown error";
#else
            zBuf = Marshal.GetLastWin32Error()
                .ToString(); //new Win32Exception( Marshal.GetLastWin32Error() ).Message;
#endif
            return 0;
        }
...
#if WINDOWS_PHONE
            fs =
 new System.IO.IsolatedStorage.IsolatedStorageFileStream(zConverted, dwCreationDisposition, dwDesiredAccess, dwShareMode, System.IO.IsolatedStorage.IsolatedStorageFile.GetUserStoreForApplication());
...
//DWORD cnt = GetTickCount();
    ...
    */
        private static int winCurrentTime(sqlite3_vfs pVfs, ref double prNow)
        {
            ...
            */
            long timeW; /* Whole days */
            long timeF; /* Fractional Days */

            /* Number of 100-nanosecond intervals in a single day */
            const long ntuPerDay =
                10000000 * (long) 86400;

            /* Number of 100-nanosecond intervals in half of a day */
            const long ntuPerHalfDay =
                10000000 * (long) 43200;
