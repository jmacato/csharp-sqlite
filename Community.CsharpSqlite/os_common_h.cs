...
//# error "The MEMORY_DEBUG macro is obsolete.  Use SQLITE_DEBUG instead."
        ...
        private static void OSTRACE1(string X)
        {
            if (sqlite3OsTrace) sqlite3DebugPrintf(X);
        }

        private static void OSTRACE2(string X, object Y)
        {
            if (sqlite3OsTrace) sqlite3DebugPrintf(X, Y);
        }

        private static void OSTRACE3(string X, object Y, object Z)
        {
            if (sqlite3OsTrace) sqlite3DebugPrintf(X, Y, Z);
        }

        private static void OSTRACE4(string X, object Y, object Z, object A)
        {
            if (sqlite3OsTrace) sqlite3DebugPrintf(X, Y, Z, A);
        }

        private static void OSTRACE5(string X, object Y, object Z, object A, object B)
        {
            if (sqlite3OsTrace) sqlite3DebugPrintf(X, Y, Z, A, B);
        }

        private static void OSTRACE6(string X, object Y, object Z, object A, object B, object C)
        {
            if (sqlite3OsTrace) sqlite3DebugPrintf(X, Y, Z, A, B, C);
        }

        private static void OSTRACE7(string X, object Y, object Z, object A, object B, object C, object D)
        {
