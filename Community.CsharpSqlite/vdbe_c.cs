...
#if SQLITE_DEBUG
        private static int fileExists(sqlite3 db, string zFile)
        {
            var res = 0;
            var rc = SQLITE_OK;
#if SQLITE_TEST
...
*/
    ...
    */
        ...
        )
        {
            ...
            var resetSchemaOnFault = false; /* Reset schema after an error if true */
...
sqlite3VdbeIOTraceSql( p );
            ...
            if (fileExists(db, "vdbe_trace") != 0) p.trace = Console.Out;
...
start = sqlite3Hwtime();
                ...
                */
                ...
                {
                    sqlite3BeginBenignMalloc();
                    if (fileExists(db, "vdbe_sqltrace") != 0) sqlite3VdbePrintSql(p);
                    sqlite3EndBenignMalloc();
                }
#endif
              ...
              UPDATE_MAX_BLOBSIZE(pOut);
                                ...
                                */
                                ...
                                case OP_Remainder:
                                {
                                    ...
                                    long iB; /* Integer value of right operand */
              ...
              UPDATE_MAX_BLOBSIZE(pOut);
                      ...
                      */
                                case OP_ToText:
                                {
                                    ...
                                    pIn1.flags =
                                        (ushort) (pIn1.flags & ~(MEM_Int | MEM_Real | MEM_Blob | MEM_Zero));
#if SQLITE_TEST
...
Debug.Assert( pC.pVtabCursor==0 );
                                    ...
                                    if (pCrsr != null)
                                    {
                                        ...
                                        else if (pC.isIndex)
                                        {
                                            ...
                                            Debug.Assert(
                                                rc == SQLITE_OK); /* True because of CursorMoveto() call above */
                                        ...
                                        for (i = 0; i < nField; i++)
                                            if (zIdx < zEndHdr)
                                            {
                                                ...
                                                zIdx += getVarint32(zData, zIdx,
                                                    ref aType[i]); //getVarint32(zIdx, aType[i]);
                                        ...
                                        if ((pRec.flags & MEM_Zero) != 0)
                                            ...
                                            */
                                                ...
                                                pD0++) //for (pRec = pData0; pRec <= pLast; pRec++)
                                            {
                                                /* serial data */
                                                pRec = p.aMem[pOp.p1 + pD0];
                                                i += (int) sqlite3VdbeSerialPut(zNewRecord, i, (int) nByte - i,
                                                    pRec, file_format);
                                            }
                                  ...
                                  */
                                            case OP_Savepoint:
                                            {
                                                ...
                                                */
                                                ...
                                                Debug.Assert(
                                                    p1 == SAVEPOINT_BEGIN || p1 == SAVEPOINT_RELEASE ||
                                            ...
                                            */
                                            case OP_AutoCommit:
                                            {
                                                ...
                                                Debug.Assert(
                                                    db.activeVdbeCnt > 0); /* At least this one VM is active */
                                            ...
                                            */
                                            case OP_OpenEphemeral:
                                            {
                                                ...
                                                pCx.nullRow = true;
                                                rc = sqlite3BtreeFactory(db, null, true,
                                                    SQLITE_DEFAULT_TEMP_CACHE_SIZE, openFlags,
                                                    ref pCx.pBt);
                                            ...
                                            case OP_SeekGt:
                                            {
                                                ...
                                                if (pC.pCursor != null)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        **   }
                                                        */
                                                        r.flags = (ushort) (UNPACKED_INCRKEY *
                                                                            (1 & (oc - OP_SeekLt)));
                                                        Debug.Assert(
                                                            oc != OP_SeekGt || r.flags == UNPACKED_INCRKEY);
                                                        Debug.Assert(
                                                            oc != OP_SeekLe || r.flags == UNPACKED_INCRKEY);
...
** an AUTOINCREMENT table. */
                                                        ...
                                                        do
                                                        {
                                                            ...
                                                            rc = sqlite3BtreeMovetoUnpacked(pC.pCursor, null, v, 0,
                                                                ref res);
                                                            cnt++;
...
iCnt++;
                                            ...
                                            */
                                            case OP_Clear:
                                            {
                                                ...
                                                {
                                                    p.nChange += nChange;
                                                    if (pOp.p3 > 0) aMem[pOp.p3].u.i += nChange;
                                                }
