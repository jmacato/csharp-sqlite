...
namespace Community.CsharpSqlite
{
    ...
    */
        private static byte getSafetyLevel(string z)
        {
            ...
            byte[] iValue = {1, 0, 0, 0, 1, 1, 2};
            int i, n;
            if (sqlite3Isdigit(z[0])) return (byte) atoi(z);
            n = sqlite3Strlen30(z);
...
** flag if there are any active statements. */
            ...
            for (i = 0; i < ArraySize(aPragma); i++) //, p++)
            {
                ...
                if (sqlite3StrICmp(zLeft, p.zName) == 0)
                {
                    ...
                    if (ALWAYS(v))
                    {
                        ...
                        {
                            var mask = p.mask; /* Mask of bits to set or clear. */
                            if (db.autoCommit == 0)
    ...
    */
        ...
        */
        ...
        private static void sqlite3Pragma(Parse pParse, Token pId1, Token pId2, int null_4,
            int minusFlag)
        {
                ...
                if (sqlite3StrICmp(zLeft, "page_size") == 0)
                {
                    ...
                    */
                    if (sqlite3StrICmp(zLeft, "max_page_count") == 0)
                    {
                        ...
                        uint newMax = 0;
                        Debug.Assert(pBt != null);
                        if (zRight != null) newMax = (uint) atoi(zRight);
                        ...
                        */
                        if (sqlite3StrICmp(zLeft, "secure_delete") == 0)
                        {
                            ...
                            var b = -1;
                            Debug.Assert(pBt != null);
                            if (zRight != null) b = getBoolean(zRight);
                            if (pId2.n == 0 && b >= 0)
                            {
                                int ii;
                            ...
                            */
                            if (sqlite3StrICmp(zLeft, "page_count") == 0)
                            {
                                ...
                                sqlite3VdbeSetNumCols(v, 1);
                                sqlite3VdbeSetColName(v, 0, COLNAME_NAME, "page_count",
                                    SQLITE_STATIC);
                            }
                            else
                                /*
                                ...
                                */
                                if (zLeft == "page_count")
                                {
                                    ...
                                    sqlite3VdbeSetColName(_v, 0, COLNAME_NAME, "page_count",
                                        SQLITE_STATIC);
                                }
                                else
                                    /*
                                        ...
                                        */
                                        if (zLeft == "journal_mode")
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                eMode = azModeName.Length -
                                                        1; //sizeof(azModeName)/sizeof(azModeName[0]) - 1;
                                                while (eMode >= 0 && string.Compare(zRight,
                                                        azModeName[eMode],
                                                        StringComparison
                                                    ...
                                                    for (ii = 1; ii < db.nDb; ii++)
                                                        if (db.aDb[ii].pBt != null)
                                                        {
                                                            pPager = sqlite3BtreePager(
                                                                db.aDb[ii].pBt);
                                                            sqlite3PagerJournalMode(pPager,
                                                                eMode);
                                                        }
                                            ...
                                            */
                                            ...
                                            )
                                            {
                                                ...
                                                iLimit = sqlite3PagerJournalSizeLimit(pPager,
                                                    iLimit);
                                                returnSingleInt(pParse, "journal_size_limit",
                                                    iLimit);
                                            }
                                            else
                          ...
                          */
                                            ...
                                            if (sqlite3StrICmp(zLeft, "auto_vacuum") == 0)
                                            {
                                                ...
                                                if (null == zRight)
                                                {
                                                    ...
                                                    returnSingleInt(pParse, "auto_vacuum",
                                                        auto_vacuum);
                                                }
                                                else
                                                {
                                                    ...
                                                    if (ALWAYS(eAuto >= 0))
                                                    {
                                                        ...
                                                        */
                                                        var rc = sqlite3BtreeSetAutoVacuum(pBt,
                                                            eAuto);
                                                        if (rc == SQLITE_OK &&
                                                            (eAuto == 1 || eAuto == 2))
                                                        {
                                                            ...
                                                            */
                                                            VdbeOpList[] setMeta6 =
                                                            {
                                                                new VdbeOpList(OP_Transaction,
                                                                    0, 1, 0), /* 0 */
                                                                new VdbeOpList(OP_ReadCookie, 0,
                                                                    1,
                                                                    BTREE_LARGEST_ROOT_PAGE), /* 1 */
                                                                new VdbeOpList(OP_If, 1, 0,
                                                                    0), /* 2 */
                                                                new VdbeOpList(OP_Halt,
                                                                    SQLITE_OK, OE_Abort,
                                                                    0), /* 3 */
                                                                new VdbeOpList(OP_Integer, 0, 1,
                                                                    0), /* 4 */
                                                                new VdbeOpList(OP_SetCookie, 0,
                                                                    BTREE_INCR_VACUUM,
                                                                    1) /* 5 */
                                                            };
                                                            int iAddr;
                                                            iAddr = sqlite3VdbeAddOpList(v,
                                                                ArraySize(setMeta6), setMeta6);
                                                            sqlite3VdbeChangeP1(v, iAddr, iDb);
                                                            sqlite3VdbeChangeP1(v, iAddr + 1,
                                                                iDb);
                                                            sqlite3VdbeChangeP2(v, iAddr + 2,
                                                                iAddr + 4);
                                                            sqlite3VdbeChangeP1(v, iAddr + 4,
                                                                eAuto - 1);
                                                            sqlite3VdbeChangeP1(v, iAddr + 5,
                                                                iDb);
                                                            sqlite3VdbeUsesBtree(v, iDb);
                                                        }
                                                    }
                                                        ...
                                                        */
                                                            ...
                                                            "temp_store_directory") == 0)
                                                        {
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                if (zRight.Length > 0)
                                                                    sqlite3_temp_directory =
                                                                        zRight; //sqlite3DbStrDup(0, zRight);
                                                                else
                                                                    sqlite3_temp_directory = "";
                            ...
                            */
                                                                    ...
                                                                    zRight != null)
                                                                {
                                                                    ...
                                                                    if (pTab != null)
                                                                    {
                                                                        ...
                                                                        var nHidden = 0;
                                                                        Column pCol;
                                                                        sqlite3VdbeSetNumCols(v,
                                                                            6);
                                                                        pParse.nMem = 6;
                                                                        sqlite3VdbeSetColName(v,
                                                                            0, COLNAME_NAME,
                                                                            "cid",
                                                                            SQLITE_STATIC);
                                                                        sqlite3VdbeSetColName(v,
                                                                                ...
                                                                                EncName[]
                                                                                    encnames =
                                                                                    {
                                                                                        ...
                                                                                        new
                                                                                            EncName(
                                                                                                "UTF-8",
                                                                                                SQLITE_UTF8), /* Must be element [1] */
                                                                                        new
                                                                                            EncName(
                                                                                                "UTF-16le",
                                                                                                SQLITE_UTF16LE), /* Must be element [2] */
                                                                                        new
                                                                                            EncName(
                                                                                                "UTF-16be",
                                                                                                SQLITE_UTF16BE), /* Must be element [3] */
                                                                                        new
                                                                                            EncName(
                                                                                                "UTF16le",
                                                                                                SQLITE_UTF16LE),
