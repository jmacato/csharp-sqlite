    ...
    public partial class Sqlite3
    {
        ...
        */
        private void sqlite3_soft_heap_limit(int n)
        {
            ...
            if (overage > 0) sqlite3_release_memory(overage);
        }
        ...
        public class Mem0Global
        {
            ...
            */
                ...
                int Mem_Allocation, int BtCursor_Allocation)
            {
                ...
                for (var i = 0; i < aByteSize.Length; i++) aByte[i] = new byte[Byte_Allocation][];
        ...
        */
        private static int sqlite3MallocInit()
        {
                                                  ...
                                                  && sqlite3GlobalConfig.nPage >= 1)
            {
                int i;
                int overhead;
                var sz = ROUNDDOWN8(sqlite3GlobalConfig.szPage);
                var n = sqlite3GlobalConfig.nPage;
