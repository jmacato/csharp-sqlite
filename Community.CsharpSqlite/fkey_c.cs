            ...
            ** search for a matching row in the parent table.  */
            ...
            if (isIgnore == 0)
            {
                ...
                else
                {
                    ...
                    for (i = 0; i < nCol; i++) sqlite3VdbeAddOp2(v, OP_SCopy, aiCol[i] + 1 + regData, regTemp + i);
                                ...
                                */
                                ...
                                )
                                {
                                    if ((pParse.db.flags & SQLITE_ForeignKeys) != 0)
                                    {
                                            ...
                                            for (i = 0; i < p.nCol; i++)
                                            {
                                                ...
                                                for (iKey = 0; iKey < pTab.nCol; iKey++)
                                                {
                                                    ...
                                                    if (!string.IsNullOrEmpty(zKey)
                                                        ? 0 == sqlite3StrICmp(pCol.zName, zKey)
                                                        : pCol.isPrimKey != 0)
                                                    {
                                            ...
                                            */
                                            ...
                                            )
                                            {
                                                ...
                                                if (action != OE_None && null == pTrigger)
                                                {
                                                    ...
                                                    if (locateFkeyIndex(pParse, pTab, pFKey, ref pIdx, ref aiCol) !=
                                                        0) return null;
                                                    Debug.Assert(aiCol != null || pFKey.nCol == 1);
                                        ...
                                        ** hash table.
                                        */
                                            private static void sqlite3FkDelete(Table pTab)
                                            {
                                                FKey pFKey; /* Iterator variable */
                                                ...
                                                for (pFKey = pTab.pFKey; pFKey != null; pFKey = pNext)
                                                {
                                                    ...
                                                    {
                                                        var data = pFKey.pNextTo;
                                                        var z = data != null ? pFKey.pNextTo.zTo : pFKey.zTo;
                                                        sqlite3HashInsert(ref pTab.pSchema.fkeyHash, z,
                                                            sqlite3Strlen30(z), data);
                                                    }
